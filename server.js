...
app.post("/scrape-entries", async (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .content { margin-top: 10px;  margin-right: 20; display: block; }
